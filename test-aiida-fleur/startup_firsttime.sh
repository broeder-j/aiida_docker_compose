...
docker-compose exec --user aiida aiida /bin/bash -l -c "cat /home/aiida/.dockerscripts/plugin/code-setup-input_inpgen.txt | verdi code setup"
docker-compose exec --user aiida aiida /bin/bash -l -c "cat /home/aiida/.dockerscripts/plugin/code-setup-input_fleur.txt | verdi code setup"
